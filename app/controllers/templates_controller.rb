class TemplatesController < ApplicationController
  ...
  def index   
  @u = [] 
  @x = Template.find_by_user_id("#{current_user.id}")
  @array = @x.attributes.each{|i| @u << i[0]} if @x.present?
...
instance_variable_set("@t#{k}", params[t_vl])

instance_variable_set("@tab#{k}", params[tab_vl])
k= k+1
